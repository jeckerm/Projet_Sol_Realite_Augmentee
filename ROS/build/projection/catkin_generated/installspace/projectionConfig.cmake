...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'projection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/henry/Documents/Projet_Dep_Info/install/${idir}'.  Ask the maintainer 'henry <henry@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/henry/Documents/Projet_Dep_Info/install/lib;/home/henry/Documents/Projet_Dep_Info/devel/lib;/opt/ros/kinetic/lib)
