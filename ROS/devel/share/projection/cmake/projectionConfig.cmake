...
if("TRUE" STREQUAL "TRUE")
  set(projection_SOURCE_PREFIX /home/henry/Documents/Projet_Dep_Info/src/projection)
  set(projection_DEVEL_PREFIX /home/henry/Documents/Projet_Dep_Info/devel)
  ...
  set(projection_INSTALL_PREFIX /home/henry/Documents/Projet_Dep_Info/install)
...
if(NOT "/home/henry/Documents/Projet_Dep_Info/devel/include " STREQUAL " ")
  set(projection_INCLUDE_DIRS "")
  set(_include_dirs "/home/henry/Documents/Projet_Dep_Info/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'projection' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'henry <henry@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'projection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/henry/Documents/Projet_Dep_Info/src/projection/${idir}'.  Ask the maintainer 'henry <henry@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/henry/Documents/Projet_Dep_Info/devel/lib;/home/henry/Documents/Projet_Dep_Info/devel/lib;/opt/ros/kinetic/lib)
...
set(projection_EXPORTED_TARGETS "projection_generate_messages_cpp;projection_generate_messages_eus;projection_generate_messages_lisp;projection_generate_messages_nodejs;projection_generate_messages_py")
...
set(pkg_cfg_extras "projection-msg-extras.cmake")
