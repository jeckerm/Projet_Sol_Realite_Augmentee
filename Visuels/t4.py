# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 09:20:56 2017
...
class Popup(QtGui.QWidget):
    ...
    def sendData(self):
        try:
            self.parent.image.transformers(float(self.c11.text), float(self.c21.text), float(self.c12.text), float(self.c22.text))
            self.close()
        except:
            print("Must be float values")
